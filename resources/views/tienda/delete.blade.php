				...
				<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
					<div class="full-width panel mdl-shadow--2dp">
						...
						<div class="full-width panel-content">
                            {!!Form::model($store,['route'=>['Tienda.destroy',$store->store_id],'method'=>'DELETE','class'=>'form-horizontal'])!!}
                                {!! Html::decode(Form::label('Esta seguro de cambiar el estatus de la tienda <kbd>'. $store->store_dsc . '</kbd>',NULL,['class'=>''])) !!}
